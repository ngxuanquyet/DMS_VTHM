...
/// Circular Radial Floating Menu cho màn Khách hàng (CustomerScreen)
/// Bao gồm 5 option: Thêm mới khách hàng, Đồng bộ, Tải lên, Định vị, Sắp xếp theo khoảng cách
class CustomerCircularMenu extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CustomerCircularMenu> createState() => _CustomerCircularMenuState();
}

class _CustomerCircularMenuState extends ConsumerState<CustomerCircularMenu>
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      CustomerMenuItem(
        ...
        badgeCount:
            widget.pendingOfflineCount > 0 ? widget.pendingOfflineCount : null,
        onTap: () {
          _close();
      ...
      CustomerMenuItem(
        label: widget.isSortedByDistance ? 'Hủy xếp cự ly' : 'Sắp xếp theo khoảng cách',
        icon: Icons.near_me_rounded,
        color: widget.isSortedByDistance
  ...
  Widget _buildRadialItem({
    required CustomerMenuItem item,
    required int index,
